...
|-----------------|------------------------------|----------------|---------------|---------|
| P0-C0           | PCIe Gen4x16or PCIe Gen 5 x8 | P0/1           | 1             | Yes     |
| P0-C1           | PCIe Gen4x16or PCIe Gen 5 x8 | P0/0           | 2             | Yes     |
| P0-C2           | PCIe Gen4x16or PCIe Gen 5 x8 | P2/1           | 3             | Yes     |
...
| P0-C5           | PCIe Gen4x16or PCIe Gen 5 x8 | P3/0           | 6             | Yes     |

| Location code   | Description                  | Socket / PHB   |   Slot number | SRIOV   |
|-----------------|------------------------------|----------------|---------------|---------|
| P0-C6           | PCIe Gen4x16or PCIe Gen 5 x8 | P1/1           |             7 | Yes     |
| P0-C7           | PCIe Gen4x16or PCIe Gen 5 x8 | P1/0           |             8 | Yes     |
...
| ASMI     | Advanced System Management Interface        | HMC     |
| BMC      | baseboard management controller             | HNV HPT |
| BSC      | blind-swap cassette                         | IaaS    |
| CBU      | Capacity Backup                             | IBM     |
| CEC      | central electronic complex                  |         |
| CMOS     | complimentary metal-oxide-semiconductor     | IPS     |
| CoD      | Capacity on Demand                          | ISA ISV |
