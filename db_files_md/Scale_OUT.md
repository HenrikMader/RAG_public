...
| Feature code   |   Cores per eSCM |   Power saving mode frequency [GHz] |   Static mode frequency [GHz] | Maximumperformancemode frequency range [GHz]   |
|----------------|------------------|-------------------------------------|-------------------------------|------------------------------------------------|
...
| EC2T           | 58FB   | PCIe3 LP 2-Port 25/10 GbNIC&ROCESR/Cu Adapter b       | AIX, Linux c , IBM i a     | Supported    |
...
| Linux              | SUSE Linux Enterprise Server 15.5 Red Hat Enterprise Linux 9.2 or                                                                                                                                                                                                                      |
