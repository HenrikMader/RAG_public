...
4   A-busses and X-busses provide SMP fabric ports, which are used between central electronic complex (CEC) drawers or within CEC drawers respectively.
...
|----------------|------------------------------------------------------------------------------------------------------|
| #EHC8          | Solution Edition for Healthcare typical 2.95 - 3.9 GHz 24-core Processor Module (North America only) |
| #EPEU          | 12-core typical 3.35 - 4.0 GHz (maximum) processor                                                   |
| #EPEV          | 18-core 3.2 - 4.0 GHZ (maximum) processor                                                            |
| #EPGW          | 24-core 2.95 - 3.9 GHZ (maximum) processor                                                           |
...
|----------------|--------------------------------|-------------------------------------|------------------------------|------------------------------------------------|
| #EPEU          |                             12 |                                   2 |                         3.35 | 3.35 - 4.00 (max)                              |
| #EPEV          |                             18 |                                   2 |                         3.2  | 3.20 - 4.00 (max)                              |
| #EPGW          |                             24 |                                   2 |                         2.95 | 2.95 - 3.90 (max)                              |
| #EHC8 a        |                             24 |                                   2 |                         2.95 | 2.95 - 3.90 (max)                              |
...
Table 2-6   Comparing the Power10 processor technology to prior processor generations

| Characteristics                                                | Power10                                                                                                                | Power10                                                                                                                | Power10                                                                                                                | Power9                                                                                                 | Power8                                                                                             |
|----------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------|
| Characteristics                                                | DCM                                                                                                                    | eSCM                                                                                                                   | SCM                                                                                                                    | Power9                                                                                                 | Power8                                                                                             |
| Technology                                                     | 7 nm                                                                                                                   | 7 nm                                                                                                                   | 7 nm                                                                                                                   | 14 nm                                                                                                  | 22 nm                                                                                              |
| Die size                                                       | 2 x 602 mm 2                                                                                                           | 2 x 602 mm 2                                                                                                           | 602mm 2                                                                                                                | 693 mm 2                                                                                               | 649mm 2                                                                                            |
| Processor module size                                          | 74.5 mmx 85.75 mm                                                                                                      | 74.5 mm x 85.75 mm                                                                                                     | 68.5 mm x 77.5 mm                                                                                                      | 68.5 mm x 68.5 mm                                                                                      | 71.5 mm x 71.5 mm                                                                                  |
...
| L3 Cache                                                       | 8 MB of L3 cache per core, with each core having access to the full 120 MB of L3 cache, on-chip high-efficiency SRAM b | 8 MB of L3 cache per core, with each core having access to the full 120 MB of L3 cache, on-chip high-efficiency SRAM b | 8 MB of L3 cache per core, with each core having access to the full 120 MB of L3 cache, on-chip high-efficiency SRAM b | 10 MB of L3 cache per core,witheach core having access to the full 120 MB of L3 cache, on-chip eDRAM c | 8 MB of L3 cache per core,witheach core having access to the full 96 MB of L3 cache, on-chip eDRAM |
| Supported memory technology                                    | DDR4 and DDR5                                                                                                          | DDR4 and DDR5                                                                                                          | DDR4 and DDR5                                                                                                          | DDR4 and DDR3 d                                                                                        | DDR3 and DDR4                                                                                      |
| I/O bus                                                        | PCIe Gen 5                                                                                                             | PCIe Gen 5                                                                                                             | PCIe Gen 5                                                                                                             | PCIe Gen 4                                                                                             | PCIe Gen 3                                                                                         |
...
| P0-C2           | PCIe5x8orPCIe4 x16 | DCM2-P1-E1-PHB3    | Yes        | Yes                         | 1                                                  |
| P0-C3           | PCIe5x8orPCIe4 x16 | DCM2-P1-E0-PHB0    | Yes        | Yes                         | 5                                                  |
| P0-C4           | PCIe5x8orPCIe4 x16 | DCM2-P0-E1-PHB3    | No         | Yes                         | 2                                                  |
| P0-C5           | PCIe5x8orPCIe4 x16 | DCM2-P0-E0-PHB0    | No         | Yes                         | 6                                                  |
| P0-C6           | PCIe4 x8           | DCM1-P1-E1-PHB4    | Yes        | No                          | 10                                                 |
| P0-C7           | PCIe5 x8           | DCM1-P1-E1-PHB3    | Yes        | Yes                         | 7                                                  |
| P0-C8           | PCIe5x8orPCIe4 x16 | DCM1-P1-E0-PHB0    | Yes        | Yes                         | 3                                                  |
...
| Processor sockets populated   | Expansion adapter slots order                                |   Maximum number of I/O Expansion Drawers |   Maximum number of fanout modules |   Total PCIe slots |
|-------------------------------|--------------------------------------------------------------|-------------------------------------------|------------------------------------|--------------------|
| DCM0 and DCM1                 | P0-C8, P0-C11, P0-C7, and P0-C10                             |                                         2 |                                  4 |                 27 |
| DCM0, DCM1, and DCM2          | P0-C8, P0-C11, P0-C2, P0-C3, P0-C4, and P0-C5                |                                         3 |                                  6 |                 41 |
| DCM0, DCM1, DCM2, and DCM3    | P0-C8, P0-C11, P0-C2, P0-C3, P0-C4, P0-C5, P0-C7, and P0-C10 |                                         4 |                                  8 |                 51 |
...
Figure 2-17 show the login window for the ASMI.

Figure 2-17   ASMI login window
...
Figure 2-19 shows an example of the Sensors window.

Figure 2-19   ASMI Sensors window
...
## 2.6.2  Managing the system by using DMTF Redfish
...
With the token, you can get data from the server. First, request the data of the Redfish root by using /Redfish/v1 . You get data with other branches in the Redfish tree, for example, Chassis (uppercase C). To dig deeper, use the newly discovered odata.id /Redfish/v1/Chassis , as shown in Example 2-2.

```
#curl -s -k -H "X-Auth-Token: $TOKEN" -X GET https://${eBMC}/redfish/v1 { "@odata.id": "/redfish/v1", "@odata.type": "#ServiceRoot.v1_12_0.ServiceRoot", "AccountService": { "@odata.id": "/redfish/v1/AccountService" }, "Cables": { "@odata.id": "/redfish/v1/Cables" }, "CertificateService": { "@odata.id": "/redfish/v1/CertificateService" }, "Chassis": { "@odata.id": "/redfish/v1/Chassis" }, # curl -k -H "X-Auth-Token: $TOKEN" -X GET https://${eBMC}/Redfish/v1/Chassis { "@odata.id": "/Redfish/v1/Chassis", "@odata.type": "#ChassisCollection.ChassisCollection", " Members ": [ { "@odata.id": "/Redfish/v1/Chassis/chassis" } ], "Members@odata.count": 1, "Name": "Chassis Collection" # curl -k -H "X-Auth-Token: $TOKEN" -X GET https://${eBMC}/Redfish/v1/Chassis/chassis { "@odata.id": "/Redfish/v1/Chassis/chassis", "@odata.type": "#Chassis.v1_16_0.Chassis", "Actions": {
```
...
In Example 2-3, you can see what is under Sensors . There you can find the same sensors as in the ASMI GUI (see Figure 2-19 on page 78). In the output, you find, for example, the sensor total\_power . When you ask for details about that sensor, as shown in Example 2-3, you can see that the server needed 1.426 watts at the time of running the command.
...
| E1050 Feature Code   |   ProcessorSMT8 cores |   Maximum system cores | Typical frequency range   | Socket options   |
|----------------------|-----------------------|------------------------|---------------------------|------------------|
| #EPEU                |                    12 |                     48 | 3.35 - 4.00 GHz           | 2, 3, or 4       |
| #EPEV                |                    18 |                     72 | 3.20 - 4.00 GHz           | 2, 3, or 4       |
...
| Feature Code   | Description                                                                          |
|----------------|--------------------------------------------------------------------------------------|
| #EPSH          | Onecore Base Processor Activation (Pools 2.0) for #EPGW(conv.from Static) Linux only |
...
| #EN1L          | PCIe4 32 Gb4-port Optical Fibre Channel Adapter  | AIX and Linux | Both         |
...
|-------------------------|----------------------------------------------|----------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------|
| 2                       | NVMe3 and NVMe4, orNVMe8andNVMe9             | NVMe3 and NVMe4, orNVMe8andNVMe9             | NVMe3 and NVMe4, orNVMe8 andNVMe9                                                                                                                   |
...
| More than 6             | Not supported                                | Not supported                                |  First group:  NVMe3, NVMe4, NVMe8, and NVMe9  Second group:  NVMe2 and NVMe7  Third group:  NVMe5 and NVMe6  Forth group:  NVMe0 and NVMe1 |
...
Table 3-17   Best practice NVMe plug rules

| # of NVMe drives   | Two DCMs                                                                                 | Three DCMs                                                                               | Four DCMs                                                                           |
|--------------------|------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------|
| Two                | NVMe 3 and 4, or NVMe 8 and 9                                                            | NVMe 3 and 4, or NVMe 8 and 9                                                            | NVMe 3 and 4, or NVMe 8 and 9                                                       |
| Four               | NVMe 3, 4, 8, and 9                                                                      | NVMe 3, 4, 8, and 9                                                                      | NVMe 3, 4, 8, and 9                                                                 |
| Six                | NVMe 3, 4, 8, and 9 NVMe 2 and 7                                                         | NVMe 3, 4, 8, and 9 NVMe 2 and 7                                                         | NVMe 3, 4, 8, and 9 NVMe 2 and 7                                                    |
| More than 6        | NVMe 3, 4, 8, and 9 NVMe 2 and 7 N/A (No NVMe 0, 1, 5, and 6 configuration is possible.) | NVMe 3, 4, 8, and 9 NVMe 2 and 7 N/A (No NVMe 0, 1, 5, and 6 configuration is possible.) | First NVMe 3, 4, 8, and 9 Next NVMe 2 and 7 Next NVMe 5 and 6 Finally, NVMe 0 and 1 |
...
|----------------|------------------------------------------------|-----------|
| #EJ0Q a        | Storage backplane with 10 NVMe U.2 drive slots |         1 |
...
| #EC7Q          | 800GBMainstreamNVMeU.2SSD4kfor AIX/Linux (7 mm)                   |     0 |    10 | AIX and Linux |
| #EC7T          | 800GBMainstreamNVMeU.2SSD4kfor AIX/Linux (15 mm)                  |     0 |    10 | AIX and Linux |
...
| CCIN   | Feature Code   | Partnumber   | Description                             |
|--------|----------------|--------------|-----------------------------------------|
...
1   The PCIe Gen3 I/O Expansion Drawer was withdrawn from marketing.
...
Table 3-26 shows the plug sequence for the converter adapter that can be installed in the Power E1050 server.

Table 3-26   Plug sequence of converter adapter in the Power E1050

| Feature Code   | Slot priorities (Two processors) with 2 I/O drawers   |   Maximum number of adapters that are supported | Slot priorities (3 and 4 processors) with 4 I/O drawers   |   Maximum number of adapters that are supported |
|----------------|-------------------------------------------------------|-------------------------------------------------|-----------------------------------------------------------|-------------------------------------------------|
| #EJ2A          | C10, C7, C11, and C8                                  |                                               4 | C10, C7, C11, C8, C5, C3, C4, and C2                      |                                               8 |
...
Figure 3-10 shows the typical optical cable connections.

Figure 3-10   Typical optical cable connections
...
| Storage      | #EC7D          | PCIe4 3.2 TB NVMe Flash Adapter x8                   | Available                |
| Storage      | #EC7F          | PCIe4 6.4 TB NVMe Flash Adapter x8                   | Available                |
...
| SAS          | #EJ14          | 12 GB Cache RAID PLUS SAS Adapter Quad-port 6 Gb x8  | Available                |
| SAS          | #EJ0J          | PCIe3 RAID SAS Adapter Quad-port 6 Gb x8             | Available                |
| LAN          | #EC2U          | PCIe3 2-Port 25/10 Gb NIC&ROCE SR/Cu Adapter         | Available                |
| LAN          | #EN0W          | PCIe2 2-port 10/1 GbE BaseT RJ45 Adapter             | Available                |
| LAN          | #EC66          | PCIe4 2-port 100 Gb ROCE EN adapter                  | Available                |
| LAN          | #EC76          | PCIe4 2-port 100 Gb No Crypto Connectx-6 DX QFSP56   | Available                |
| Crypto       | #EJ35          | PCIe3 Crypto Co-processor no BSC 4769                | Available                |
| Crypto       | #EJ37          | PCIe3 Crypto Co-processor BSC-Gen3 4769              | Available                |
...
| Storage      | #EC5D          | PCIe3 x8 3.2 TB NVMe Flash Adapter                   | Supported                |
| Storage      | #EC5F          | PCIe3 x8 6.4 TB NVMe Flash Adapter                   | Supported                |
...
Figure 3-13 on page 115 shows the multipath support for the NED24 drawer.

Figure 3-13   NED24 multipath support

<!-- image -->

Multipath support is provided in the OSs that are shown in Table 3-30.

Table 3-30   Multipath support by operating system

| Operating system   | Supported releases                                                                                                                                                                                                                                                |
|--------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| AIX                |  AIX 7.3 with the 7300-02 Technology Level and Service Pack 7300-02-02-2420 or later  AIX 7.2 with the 7200-05 Technology Level and Service Pack 7200-05-08-2420 or later  AIX 7.3 with the 7300-01 Technology Level and Service Pack 7300-01-04-2420 or later |
| Linux              |  SUSE Linux Enterprise Server 15.5 or later  Red Hat Enterprise Linux 9.2 or later                                                                                                                                                                              |
...
2   The EXP24SX was withdrawn from marketing. Consider using the NVMe-based NED24 instead.
...
Table 4-1 shows the differences, from a RAS perspective, in the Power10 processor-based family.

Table 4-1   Power10 Servers RAS highlights comparison

| Item                                                                                                                                                                                                                                                                            | IBM Power S10xx   | IBM Power E1050   | IBM Power E1080   |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------|-------------------|-------------------|
| Base Power10 processor RAS features:  First Failure Data Capture (FFDC)  Processor Instruction Retry (PIR)  L2/L3 Cache error correction code (ECC) protection with cache line-delete  Power/cooling monitor function integrated into on-chip controllers of the processors | Yes.              | Yes.              | Yes.              |
| Power10EnterpriseRASfeature:Core Checkstops                                                                                                                                                                                                                                     | Yes.              | Yes.              | Yes.              |

| Item                                                                                                                                                          | IBM Power S10xx                                                                        | IBM Power E1050                                         | IBM Power E1080                                                                                                                                 |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------|---------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------|
| Multi-node symmetric multiprocessing Fabric RAS: cyclic redundancy check (CRC)-checked processor fabric bus retry with spare data lane or bandwidth reduction | N/A.                                                                                   | N/A.                                                    | Yes. The Power10 processor-based design removes active components on the cable and introduces internal cables to reduce backplane replacements. |
| Hot-plug with processor integrated                                                                                                                            | Yes.                                                                                   | Yes.                                                    | Yes.                                                                                                                                            |
| Memory DIMM ECC supporting x4                                                                                                                                 | Yes.                                                                                   | Yes.                                                    | Yes.                                                                                                                                            |
| Dynamic Memory Row repair and spare dynamic RAM (DRAM) capability                                                                                             | 2U DDIMM: No spare DRAM. Dynamic Row Repair.                                           | 4U DDIMM: Two spare DRAMs per rank. Dynamic Row Repair. | 4U DDIMM: Two spare DRAMs per rank. Dynamic Row Repair.                                                                                         |
| Active Memory Mirroring (AMM) for Hypervisor                                                                                                                  | Yes: Base. New to scale-out.                                                           | Yes: Base.                                              | Yes: Base.                                                                                                                                      |
| Redundant or spare voltagephaseson voltage converters for levels feeding the processor                                                                        | No.                                                                                    | Yes: N+1.                                               | Yes: N+2.                                                                                                                                       |
| Redundant On-board Power Management Integrated Circuits (PMICs) memory DDIMMs                                                                                 | No. 2U DDIMM.                                                                          | Yes: Base. 4U DDIMM.                                    | Yes: Base.                                                                                                                                      |
| Service processor type                                                                                                                                        | Enterprise Baseboard Management Controller (eBMC). Open standard with Redfish support. | eBMC. Open standard with Redfish support.               | Flexible Service Processor (FSP). IBM proprietary.                                                                                              |
| Processor clocks redundancy/sparing                                                                                                                           | No.                                                                                    | No.                                                     | Redundant.                                                                                                                                      |
| Redundant service processor and related boot facilities                                                                                                       | No.                                                                                    | No.                                                     | Yes.                                                                                                                                            |
| Redundant trusted platform module (TPM) capability                                                                                                            | No.                                                                                    | No.                                                     | Yes.                                                                                                                                            |
...
This new memory subsystem design delivers solid RAS. Unlike the processor RAS characteristics, the E1050 memory RAS varies from the RAS of the IBM Power E950. The Power E1050 supports the same 4U DDIMM height as the IBM Power E1080.
...
| Item              | Power E950 memory                       | Power E1050 memory     | RAS impact                                                                                                                                                                                                                                                   |
|-------------------|-----------------------------------------|------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| DIMM form factor  | Riser card plus industry-standard DIMMs | 4U DIMM                |  Power E1050 4U DDIMM: Single field-replaceable unit (FRU) or fewer components to replace.  Power E950 DIMM: A separate FRU is used for a memory buffer on a riser card and the industry-standard DIMMs.                                                   |
| Symbol correction | Single symbol correction                | Dual symbol correction |  Power E1050 4U DDIMM: A data pin failure (1 symbol) that lines up with single cell failure on another DRAM is still correctable.  Power E950 DIMM: A data pin failure (1 symbol) that lines up with single cell failure on another DRAM is uncorrectable. |

| Item                          | Power E950 memory                 | Power E1050 memory                   | RAS impact                                                                                                                                                                                                                                                                                                                                      |
|-------------------------------|-----------------------------------|--------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| X4 Chipkill                   | OnespareDRAM across a DIMM repair | Single DRAM Chipkill correction plus |  Power E1050 4U DDIMM: - The first Chipkill is fixed with a spare. - The second Chipkill is fixed with a spare. - The third Chipkill is fixed with ECC. - The fourth Chipkill is uncorrectable.  Power E950 DIMM: - The first Chipkill is fixed with a spare. - The second Chipkill is fixed with ECC. - The third Chipkill is uncorrectable. |
| DRAM row repair               | Static                            | Dynamic                              |  Power E1050 4U DDIMM: Detect, fix, and restore at run time without a system outage.  Power E950 DIMM: Detect at run time, but a fix and restore requires a system restart.                                                                                                                                                                   |
| L4 cache                      | Yes                               | No                                   |  Power E1050 4U DDIMM: Avoids L4 cache failure modes.  Power E950 DIMM: The L4 cache fail rate is a significant contributor to DIMM replacements.                                                                                                                                                                                             |
| Voltage regulation redundancy | No                                | Yes                                  |  Power E1050 4U DDIMM: Can survive a voltage regulation component failure.  Power E950 DIMM: Voltage regulation and associated components are a single point of failure.                                                                                                                                                                      |
...
| SSH    | Secure Shell                             |
| SSIC   | IBM System Storage Interoperation Center |
| SSO    | single sign-on                           |
| ST     | single-threaded                          |
...
-  IBM Power10 Scale Out Servers Technical Overview S1012, S1014, S1022s, S1022 and S1024 , REDP-5675
...
-  IBM Power S1012 Technical Overview and Introduction , REDP-5728
...
-  Support for IBM Systems:

https://www.ibm.com/mysupport/s/?language=en\_US
