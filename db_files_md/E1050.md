...
| Maximum noise level                 | 8.2 bels LwAm(heavyworkload on one maximally configured 4-socket enclosure, 2 TB memory, 25°C, 500 m) | N/A                                 |
...
| Feature Code   |   Cores per single-chip module |   Power-saving mode frequency (GHz) |   Static mode frequency (GHz) | Maximumperformancemode frequency range (GHz)   |
|----------------|--------------------------------|-------------------------------------|-------------------------------|------------------------------------------------|
...
|-------------------------|----------------------------------------------|----------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------|
| 2                       | NVMe3 and NVMe4, or NVMe8andNVMe9            | NVMe3 and NVMe4, or NVMe8and NVMe9           | NVMe3 and NVMe4, or NVMe8 and NVMe9                                                                                                                 |
...
| #EC7Q          | 800 GBMainstreamNVMeU.2SSD4kfor AIX/Linux (7 mm)                  |     0 |    10 | AIX and Linux |
| #EC7T          | 800 GBMainstreamNVMeU.2SSD4kfor AIX/Linux (15 mm)                 |     0 |    10 | AIX and Linux |
...
| Redundant or spare voltage phases on voltage converters for levels feeding the processor                                                                      | No.                                                                                    | Yes: N+1.                                               | Yes: N+2.                                                                                                                                       |
...
| AOC       | Active Optical Cable                           | eBMC     | enterprise BaseboardManagement Controller         |
...
|           | metal-oxide-semiconductor Capacity on Demand   | FHE      | fully homomorphic encryption                      |
...
| CUoD CVEs | Capacity Upgrade on Common Vulnerabilities and | GA       | General Availability GNU Compiler Collection      |
