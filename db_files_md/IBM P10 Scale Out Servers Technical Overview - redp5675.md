...
## 2.2.2  Processor modules for Power10 Scale Out Servers
...
| 12-core           | DCM           | Yes            | Yes                | 3.4 - 4.0                       |                             1 | -             | -             | -              | -             | X             |
| 16-core           | DCM           | Yes            | Yes                | 2.75 - 4.0                      |                             2 | -             | -             | -              | X             | -             |
| 16-core           | DCM           | Yes            | Yes                | 3.1 - 4.0                       |                             2 | -             | -             | -              | -             | X             |
...
| Power S1022s   | 128                  | DDR4             |                    2666 | 2048                           |                                             341 |
| Power S1022s   | 128                  | DDR5             |                    3200 | 2048                           |                                             820 |
| Power S1022s   | 64, 32, 16           | DDR4             |                    3200 | 1024 a                         |                                             820 |
| Power S1022s   | 64, 32, 16           | DDR5             |                    3200 | 1024 a                         |                                             820 |
...
Table 2-7   Characteristic frequencies and frequency ranges for Power S1012 servers

| Feature code   |   Cores per module |   Power saving mode frequency [GHz] |   Staticmode frequency [GHz] | Maximumperformancemode frequency range [GHz]   |
|----------------|--------------------|-------------------------------------|------------------------------|------------------------------------------------|
| EPG3           |                  1 |                                   2 |                            3 | 3.0 to 3.90 (max)                              |
| EPG7           |                  4 |                                   2 |                            3 | 3.0 to 3.90 (max)                              |
| EPGZ           |                  8 |                                   2 |                            3 | 3.0 to 3.90 (max)                              |

Table 2-8   Characteristic frequencies and frequency ranges for Power S1014 servers

| Feature code   | Cores per module   |   Power saving mode frequency [GHz] |   Staticmode frequency [GHz] | Maximumperformancemode frequency range [GHz]   |
|----------------|--------------------|-------------------------------------|------------------------------|------------------------------------------------|
| #EPG0          | 4 a                |                                   2 |                         3    | 3.0 to 3.90 (max)                              |
| #EPG2          | 8 a                |                                   2 |                         3    | 3.0 to 3.90 (max)                              |
...
| Feature code   |   Cores per eSCM |   Power saving mode frequency [GHz] |   Staticmode frequency [GHz] | Maximumperformancemode frequency range [GHz]   |
|----------------|------------------|-------------------------------------|------------------------------|------------------------------------------------|
| #EPGR          |                4 |                                   2 |                            3 | 3.0 to 3.90 (max)                              |
| #EPGQ          |                8 |                                   2 |                            3 | 3.0 to 3.90 (max)                              |

Table 2-10   Characteristic frequencies and frequency ranges for Power S1022 servers

| Feature code   |   Cores per dual-chip module |   Power saving mode frequency [GHz] |   Staticmode frequency [GHz] | Maximumperformancemode frequency range [GHz]   |
|----------------|------------------------------|-------------------------------------|------------------------------|------------------------------------------------|
...
| Feature code   |   Cores per dual-chip module |   Power saving mode frequency [GHz] |   Staticmode frequency [GHz] | Maximumperformancemode frequency range [GHz]   |
|----------------|------------------------------|-------------------------------------|------------------------------|------------------------------------------------|
| #EPGM          |                           12 |                                   2 |                         3.4  | 3.40 - 4.0                                     |
| #EPGC          |                           16 |                                   2 |                         3.1  | 3.10 - 4.0                                     |
| #EPGD          |                           24 |                                   2 |                         2.75 | 2.75 - 3.9                                     |
...
4   The second buffer port is not available in the 32 GB DDR5 DDIMM.
...
As previously discussed, the Power S1012 has a unique memory architecture among the Power10 Scale Out server models in that it utilizes Industry Standard DIMMs instead of the DDIMMs used in the other Scale Out servers.
...
| Feature code   | Description                                             |
|----------------|---------------------------------------------------------|
| #EM6N          | 32 GB (2x16GB) DDIMMs, 3200 MHz, 8-bit DDR4 memory      |
| #EM6W          | 64 GB (2x32GB) DDIMMs, 3200 MHz, 8-Gbit DDR4 memory     |
| #EM6X          | 128 GB (2x64GB) DDIMMs, 3200 MHz, 16-Gbit DDR4 memory   |
| #EM6U          | 256 GB (2x128GB) DDIMMs, 2933 MHz, 16-Gbit DDR4 memory  |
| #EM78          | 512 GB (2x256GB) DDIMM, 2933 MHz, 16-Gbit DDR4 memory   |
| #EMFA          | 64 GB (2x32 GB) DDIMMs, 3200 MHz, 8 Gbit DDR5 memory    |
| #EMFB          | 128 GB (2x64 GB) DDIMMs, 3200 MHz, 16 Gbit DDR5 memory  |
| #EMFD          | 256 GB (2x128 GB) DDIMMs, 3200 MHz, 16 Gbit DDR5 memory |
| #EMFE          | 512 GB (2x256GB) DDIMM, 3200 MHz, 16-Gbit DDR5 memory   |
...
|------------------|------------------------------------------------------------------|------------------------------------------------------------------|------------------------------------------------------------------|------------------------------------------------------------------|
|                  | Power S1014                                                      | Power S1022s                                                     | Power S1014                                                      | Power S1022s                                                     |
| 2 DDR5 b         | 51 102                                                           | 51 102                                                           | 43 102                                                           | 43 102                                                           |
| 4 DDR5 b         | 102 204                                                          | 102 204                                                          | 85 204                                                           | 85 204                                                           |
| 6 DDR5 b         | 154 308                                                          | 154 308                                                          | 128 256                                                          | 128 256                                                          |
| 8 DDR5 b         | 205 410                                                          | 205 410                                                          | 170 410                                                          | 170 410                                                          |
| 10 DDR5 b        | - -                                                              | 256 512                                                          | - -                                                              | 213 512                                                          |
| 12 DDR5 b        | - -                                                              | 307 614                                                          | - -                                                              | 256 614                                                          |
...
| 2 DDR5 b         | 51 102                                                                                      | - -                                                                                         | 47 102                                                                      | - -                                                                         |
| 4 DDR5 b         | 102 204                                                                                     | 102 204                                                                                     | 94 204                                                                      | 94 204                                                                      |
...
| EC2T           | 58FB   | PCIe3 LP 2-Port 25/10GbNIC&ROCESR/Cu Adapter b        | AIX, Linux c , IBM i a     | Supported    |
...
| EC75           | 2CFB   | PCIe4 LP2-port 100GbNoCryptoConnectx-6 DX QFSP56      | AIX, Linux, IBM i a        | Both         |
...
| EC76           | 2CFB   | PCIe4 LP2-port 100GbNoCrypto Connectx-6 DX QFSP56   | AIX, Linux, IBM i a              | Both         |
...
| EC78           | 2CFA   | PCIe4 2-port 100 Gb Crypto ConnectX-6 DX QFSP56 | IBM i only b                        |              |
...
| Feature code   | CCIN   | Description                                               |   Minimum |   Maximum | Operating system support   |
|----------------|--------|-----------------------------------------------------------|-----------|-----------|----------------------------|
| EKF2           | 5B53   | Enterprise 800 GBSSDPCIe4 NVMe U.2 module for IBM i       |         0 |        16 | IBM i                      |
...
| ES1K           | 5947   | Enterprise 800 GBSSDPCIe4 NVMe U.2 module for IBM i       |         0 |        16 | IBM i b                    |
| ES3A           | 5B53   | Enterprise 800 GBSSDPCIe4 NVMeU.2 module for IBM i        |         0 |        16 | IBM i                      |
...
Figure 3-10 shows the back view of the PCIe Gen3 I/O expansion drawer.

Figure 3-10   Rear view of the PCIe Gen3 I/O expansion drawer
...
|--------------------------|-------------------------------------|-----------------------------------------|----------------------|
| Power S1014 (1-socket) a | 1 b                                 | 1                                       | 10                   |
| Power S1022s (1-socket)  | 1 b                                 | 1                                       | 10                   |
...
| AIX                | 7.2 and 7.3                           |
| IBM i              | 7.4 and 7.5                           |
| Linux              | SLES 15 and SLES 16 RHEL 8 and RHEL 9 |
| VIOS               | 3.1.4.21                              |
...
|           6653 | IEC309,3P+N+G, 16 A    | 230                    |       3 | 16 amps/phase    | Internationally available |
...
|                                                        | Server&AttachedEMX0 I/O Expansion Drawer Adapters   | Server&AttachedEMX0 I/O Expansion Drawer Adapters   |
|--------------------------------------------------------|-----------------------------------------------------|-----------------------------------------------------|
...
The Power S1014 brings all of the benefits of Power10 to the Oracle environment. With the built in power hypervisor, described in 4.1.1, 'IBM Power Hypervisor' on page 180, consolidation of multiple servers is easy and efficient and does not have the overhead of software virtualization products as seen in the x86 world. Add to that the proven reliability and security of the Power platform over time and you have even more advantages compared to x86 alternatives.

Power10 adds additional benefits with its built in transparent memory encryption, described in 4.4.2, 'Cryptographic engines and transparent memory encryption' on page 199, further adding to the security or your enterprise critical databases. If you are looking to add AI capabilities, Power10 provides built in AI inferencing capability as discussed in 4.5.1, 'Train anywhere, deploy on Power10 processor-based server' on page 205.
...
- IBM Power Private Cloud with Shared Utility Capacity: Featuring Power Enterprise Pools 2.0, SG24-8476
